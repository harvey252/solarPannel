...
# Game state
dragging, current_order, game_started, info_slide_shown, well_done_message_shown = None, len(components), False, False, False
...
def draw_start_screen():
    ...
    screen.blit(font.render("Start Game", True, WHITE), (WIDTH // 2 - 50, HEIGHT // 2 - 20))
    return start_button
