...
# Load images
intro_image = pygame.image.load('images/slide.jpg')
intro_image = pygame.transform.scale(intro_image, (WIDTH, HEIGHT))
background_image = pygame.image.load('images/Solarbackground.jpg')  
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if game_state == "intro" and event.key == pygame.K_SPACE:
                game_state = "playing"
            elif game_state == "playing" and panel_assembled and event.key == pygame.K_SPACE:
